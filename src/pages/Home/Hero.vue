...
<template>
  <div class="relative bg-white overflow-hidden">
        ...
        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              {{ ' ' }}
              <span class="block text-blue-600 xl:inline">Children</span>
            </h1>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://media.istockphoto.com/photos/multiethnic-high-school-students-hanging-out-in-hallway-picture-id1271187515?b=1&k=20&m=1271187515&s=170667a&w=0&h=jgAsIaI9AgKVb55UDoPPODA63GWwObXp2WekNAfdj4Q=" alt="" />
    </div>
  </div>
</template>
